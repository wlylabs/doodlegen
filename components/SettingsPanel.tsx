      ...
      >
        ...
        <Field label="Palet warna">
          ...
          <Note>
            ...
            hitam K100 — satu plat cetak, bersih saat difotokopi, hemat tinta. Halaman isi juga
            tidak diberi hiasan apa pun: hanya karakter, garis bantu, judul, dan nomor halaman,
            supaya seluruh area kerja jadi milik anak.
          </Note>
        </Field>
        <Toggle
