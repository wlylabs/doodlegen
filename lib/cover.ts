...
export const IMAGE_SPECS: ImageSpec[] = [
  ...
  {
    id: 'tpt-mockup',
    label: 'TPT — mockup kertas',
    note: 'Foto tambahan: lembarannya sebagai kertas di atas meja',
    kind: 'mockup',
    width: 1200,
    height: 1600,
    market: 'Teachers Pay Teachers',
  ...
  {
    id: 'gumroad-inside',
    label: 'Gumroad — isi lengkap',
    note: 'Gambar kedua di korsel halaman produk: semua halaman dalam satu kisi',
    kind: 'grid',
    width: 1280,
    height: 720,
    market: 'Gumroad',
  ...
  {
    id: 'shopee-mockup',
    label: 'Shopee — mockup kertas',
    note: 'Foto ketiga: lembarannya sudah dicetak, bukan berkas di layar',
    kind: 'mockup',
    width: 1200,
    height: 1200,
    market: 'Shopee / Tokopedia',
  ...
  },
  {
    ...
    note: 'Foto keempat: file digital, tidak ada barang dikirim',
    kind: 'steps',
    width: 1200,
    height: 1200,
    market: 'Shopee / Tokopedia',
  ...
  {
    id: 'pinterest-inside',
    label: 'Pinterest — isi lengkap',
    note: 'Pin kedua untuk produk yang sama, rasio 2:3',
    kind: 'grid',
    width: 1000,
    height: 1500,
    market: 'Pinterest',
